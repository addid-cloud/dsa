...
public class HashMapExample {
    public static void main(String[] args) {
        ...
        System.out.println("Nama mahasiswa dengan NIM 1802 adalah: " + studentName);
        System.out.println("\n--- 3. Mengubah Nilai (put/replace) ---");
        studentMap.put("1803", "Citra Kusuma");
        ...
        // 8. Mendapatkan ukuran
        System.out.println("\n--- 7. Ukuran ---");
        System.out.println("Jumlah mahasiswa saat ini: " +
                studentMap.size());

        // 9. Membersihkan seluruh isi HashMap
        studentMap.clear();
